                            ...
                            <div class="card">
                                ...
                                <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                    ...
                                    <div class="tab-pane fade show {{ $k == 'vi' ? 'active' : '' }}" id="tabs-lang-{{ $k }}" role="tabpanel" aria-labelledby="tabs-lang">
                                        ...
                                        @endif
                                        @if (($configMan->slogan) ?? false == true)
                                        <div class="form-group last:!mb-0">
                                            <label class="form-label" for="slogan{{ $k }}">Slogan
                                                ({{ $k }})
                                                :</label>
                                            <input type="text" class="form-control for-seo text-sm" name="data[slogan{{ $k }}]" id="slogan{{ $k }}" placeholder="Slogan ({{ $k }})" value="{{ !empty(Flash::has('sloganvi')) ? Flash::get('sloganvi') : $item['slogan' . $k] }}" required>
                                        </div>
                                        @endif
