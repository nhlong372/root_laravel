<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-header small">
            ...
            <ul class="menu-body">
                <li class="menu-item menu-item-main {{ $type == "" && $com == "admin" ? 'active' : '' }}">
                ...
                <ul class="menu-body">
                    @foreach ($configType->product as $key => $value)
                        @if (!empty($value->categories))
                            <li class="menu-item menu-item-main {{ ($type == $key && in_array('product',explode('-',$com))) ? 'open' : '' }}">
        ...
        @if (!empty($configType->users->active))
            <li class="menu-header small">
                <a href="javascript:void(0);" class="menu-title">
