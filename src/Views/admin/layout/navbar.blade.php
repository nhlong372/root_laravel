...
<nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center justify-content-between bg-navbar-theme container-fluid"
    ...
    <div class=" navbar-nav d-flex flex-row align-items-xl-center me-3 me-xl-0 d-flex align-items-center">
        ...
        <a class="nav-item nav-link px-0 me-xl-4 d-none d-xl-flex" href="javascript:void(0)" x-data="timeOfDayIcons" x-init="setTimeOfDay()">
            <i class="ti ti-sm pr-15" x-text="icon"></i>
            <span data-i18n="WelcomeAdmin" class="welcome">Xin chào: {{ \Auth::guard('admin')->user()->fullname }} </span>
        </a>
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <li class="nav-item me-2 me-xl-0">
                <a class="nav-link text-primary bold">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-php" width="30" height="30" viewBox="0 0 24 24" stroke-width="1.5" stroke="#c02026" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li class="nav-item me-2 me-xl-0">
                <a class="nav-link" target="_blank" href="{{request()->getSchemeAndHttpHost().config('app.site_path')}}" >
                    <i class="ti ti-md ti-arrow-back" data-bs-toggle="tooltip" data-bs-trigger="hover"  data-bs-placement="bottom"  title="Xem Website"></i>
                </a>
            </li>
            ...
            <li class="nav-item dropdown-shortcuts navbar-dropdown dropdown me-2 me-xl-0">
                <a
                        ...
                        aria-expanded="false">
                    <i class="ti ti-layout-grid-add ti-md" data-bs-toggle="tooltip" data-bs-trigger="hover"  data-bs-placement="bottom"  title="Liên kết nhanh"></i>
                </a>
                    ...
                    <div class="dropdown-shortcuts-list scrollable-container">
                        <div class="row row-bordered overflow-visible g-0">
                            ...
                            <div class="dropdown-shortcuts-item col-6">
                                ...
                                <a href="{{url('admin',$v['link'])}}" class="stretched-link">{{$v['title']}}</a>
                        ...
                        <div class="row row-bordered overflow-visible g-0">
                          ...
                          <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                            <i class="ti ti-users fs-4"></i>
                                ...
                                <a href="{{url('admin',['com'=>'user-admin','act'=>'man','type'=>'tai-khoan'])}}" class="stretched-link">Tài khoản</a>
                          ...
                          <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                            <i class="ti ti-lock fs-4"></i>
                                ...
                                <a href="{{url('admin',['com'=>'user-admin','act'=>'man','type'=>'tai-khoan'])}}?changepass=1" class="stretched-link">Tài khoản</a>
                        ...
                        <div class="row row-bordered overflow-visible g-0">
                          ...
                          <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                            <i class="ti ti-settings fs-4"></i>
                                ...
                                <a href="{{url('admin',['com'=>'setting','act'=>'man','type'=>'cau-hinh'])}}" class="stretched-link">Cấu hình</a>
                                    ...
                                    <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <small class="text-muted">{{ \NINA\Models\NewslettersModel::where('confirm_status',1)->where('type',$key)->count() }} tin mới</small>
                                            </div>
                                            <div class="flex-shrink-0 dropdown-notifications-actions">
                                                <a href="{{url('admin',['com'=>'newsletters','act'=>'man','type'=>$key])}}" class=""><span class="badge badge-dot">Xem tin <i class="fa-regular fa-eye"></i></span></a>
                                            </div>
                                        </div>
                                    </li>
                                @endforeach
                                ...
                                <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted">{{\NINA\Models\OrdersModel::where('order_status',1)->count()}} đơn hàng mới</small>
                                        </div>
                                        <div class="flex-shrink-0 dropdown-notifications-actions">
                                            <a href="{{url('admin',['com'=>'order','act'=>'man','type'=>'don-hang'])}}" class=""><span  class="badge badge-dot">Xem đơn hàng <i class="fa-regular fa-eye"></i></span></a>
                                        </div>
                                    </div>
                                </li>
                            @endif
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <i class="ti ti-user ti-md" data-bs-toggle="tooltip" data-bs-trigger="hover"  data-bs-placement="bottom"  title="Cấu hình"></i>
                
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item" href="{{url('admin',['com'=>'user-admin','act'=>'man','type'=>'tai-khoan'])}}">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <span class="fw-medium d-block text-capitalize">{{ \Auth::guard('admin')->user()->fullname }}</span>

                                </div>
                            </div>
                        </a>
                    </li>
                    @if (config('type.extensions'))
                    <li>
                        <div class="dropdown-divider"></div>
                    </li>
                    <li>
                        <a class="dropdown-item" href="{{url('admin',['com'=>'extensions','act'=>'man','type'=>'hotline'])}}">
                    ...
                    <li>
                        <a class="dropdown-item" href="{{url('admin',['com'=>'extensions','act'=>'man','type'=>'social'])}}">
                    ...
                    <li>
                        <a class="dropdown-item" href="{{url('admin',['com'=>'setting','act'=>'man','type'=>'cau-hinh'])}}">
                    ...
                    <li>
                        <a class="dropdown-item" href="{{url('admin',['com'=>'log','act'=>'man','type'=>'history'])}}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-history me-2" width="22" height="22" viewBox="0 0 24 24" stroke-width="1.5" stroke="#666" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
