                    ...
                    <div class="d-flex align-content-center flex-wrap gap-2">
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn bg-success submit-check"><i class="far fa-save mr-2"></i>
                                Lưu</button>
                            <button type="button"
                                onclick="location.href='{{ $com . '/man/' . $type . '?id_product=' . $id_product }}'"
        ...
        <div
            ...
            <div class="d-flex align-content-center flex-wrap gap-2">
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn bg-success submit-check"><i class="far fa-save mr-2"></i>
                        Lưu</button>
                    <button type="reset" class="btn btn-primary"><i class="fas fa-redo mr-2"></i> Quay
                        lại</button>

                    <input type="hidden" name="id_product" value="{{ !empty($id_product) && $id_product > 0 ? $id_product : '' }}">
                    
                        <input type="hidden" name="id_properties"
                        value="{{ !empty($id_properties) && $id_properties > 0 ? $id_properties : '' }}">
