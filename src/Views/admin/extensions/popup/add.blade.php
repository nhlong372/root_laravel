    ...
    <div class="container-xxl flex-grow-1 container-p-y container-fluid">
        <div class="app-ecommerce">
            <form class="validation-form" novalidate method="post"
                action="{{ url('admin', ['com' => $com, 'act' => 'save', 'type' => $type]) }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="custom-control custom-radio d-inline-block mr-3 text-md">
                                        <input class="custom-control-input status-ex" type="radio" id="status-cb"
                                            name="data[options][type]"
                                            {{ !empty($options['type']) && $options['type'] == 1 ? 'checked' : '' }}
                                            value="1">
                                        <label for="status-cb" class="custom-control-label font-weight-normal">Cơ
                                            bản</label>
                                    </div>
                                    @if (config('type.popupnc') == true)
                                        <div class="custom-control custom-radio d-inline-block mr-3 text-md">
                                            <input class="custom-control-input status-ex" type="radio" id="status-nc"
                                                name="data[options][type]"
                                                {{ !empty($options['type']) && $options['type'] == 2 ? 'checked' : '' }}
                                                value="2">
                                ...
                                <div
                                    class="cb-status {{ !empty($options['type']) && $options['type'] == 1 ? 'd-block' : 'd-none' }}">
                                    <div class="row">
                                    </div>
                                </div>
                                @if (config('type.popupnc') == true)
                                    <div
                                        class="nc-status {{ !empty($options['type']) && $options['type'] == 2 ? 'd-block' : 'd-none' }}">
                                        <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4 col-sm-6">
                                                        <div class="view-ext">
                                                            <img onerror="this.src='../assets/images/noimage.png';"
                                                                src="../assets/admin/img/popup/popup{{ $k + 1 }}.png"
                                                                alt="popup{{ $k + 1 }}" />
                                                        </div>
                                                        <div class="custom-control custom-radio text-md mt-3">
                                                            <input class="custom-control-input" type="radio"
                                                                id="popup{{ $k + 1 }}"
                                                                value="popup{{ $k + 1 }}" name="data[options][popup]"
                                                                {{ !empty($options['popup']) && $options['popup'] == 'popup' . $k + 1 ? 'checked' : '' }}
                                                                value="1">
                                                            <label for="popup{{ $k + 1 }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4 col-sm-6">
                                                ...
                                                <div class="flex-ip">
                                                    <div class="custom-control custom-checkbox my-checkbox d-inline-block">
                                                        <input type="checkbox" name="data[options][fullname]"
                                                            class="custom-control-input" value="fullname"
                                                            {{ !empty($options['fullname']) && $options['fullname'] != '' ? 'checked' : '' }}>
                                                        <label for="selectall-checkbox"
                                                ...
                                                <div class="flex-ip">
                                                    <div class="custom-control custom-checkbox my-checkbox d-inline-block">
                                                        <input type="checkbox" name="data[options][hotline]"
                                                            class="custom-control-input" value="hotline"
                                                            {{ !empty($options['hotline']) && $options['hotline'] != '' ? 'checked' : '' }}>
                                                        <label for="selectall-checkbox"
                                                            class="custom-control-label"></label>
                                                    </div>
                                                ...
                                                <div class="flex-ip">
                                                    <div class="custom-control custom-checkbox my-checkbox d-inline-block">
                                                        <input type="checkbox" name="data[options][address]"
                                                            class="custom-control-input" value="address"
                                                            {{ !empty($options['address']) && $options['address'] != '' ? 'checked' : '' }}>
                                                        <label for="selectall-checkbox"
                                                            class="custom-control-label"></label>
                                                    </div>
                                                ...
                                                <div class="flex-ip">
                                                    <div class="custom-control custom-checkbox my-checkbox d-inline-block">
                                                        <input type="checkbox" name="data[options][email]"
                                                            class="custom-control-input" value="email"
                                                            {{ !empty($options['email']) && $options['email'] != '' ? 'checked' : '' }}>
                                                        <label for="selectall-checkbox"
                                                            class="custom-control-label"></label>
                                                    </div>
                                                ...
                                                <div class="flex-ip">
                                                    <div class="custom-control custom-checkbox my-checkbox d-inline-block">
                                                        <input type="checkbox" name="data[options][content]"
                                                            class="custom-control-input" value="content"
                                                            {{ !empty($options['content']) && $options['content'] != '' ? 'checked' : '' }}>
                                                        <label for="selectall-checkbox"
                                                            class="custom-control-label"></label>
                                                    </div>
                                            ...
                                            <div class="form-group col-md-4 col-sm-6">
                                                ...
                                                @if (!empty($configType->seopage))
                                                    @foreach ($configType->seopage as $key => $value)
                                                        <div class="flex-ip">
                                                            <div
                                                                class="custom-control custom-checkbox my-checkbox d-inline-block">
                                                                <input type="checkbox"
                                                                    name="data[options][{{ $key }}]"
                                                                    class="custom-control-input"
                                                                    value="{{ $key }}"
                                                                    {{ !empty($options[$key]) && $options[$key] != '' ? 'checked' : '' }}>
                                                                <label for="selectall-checkbox"
                                                                    class="custom-control-label"></label>
                                                            </div>
                                            ...
                                            <div class="form-group col-md-4 col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control jscolor text-sm"
                                                        name="data[options][background]" maxlength="7"
                                                        value="{{ isset($options['background']) && $options['background'] != '' ? $options['background'] : '#000000' }}">
                                                </div>

                                                <div class="mb-2">
                                                    <h5 class="mb-2 tt-15">Màu chữ tiêu đề</h5>
                                                    <input type="text" class="form-control jscolor text-sm"
                                                        name="data[options][color-title]" maxlength="7"
                                                        value="{{ isset($options['color-title']) && $options['color-title'] != '' ? $options['color-title'] : '#000000' }}">
                                                </div>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control jscolor text-sm"
                                                        name="data[options][color-send]" maxlength="7"
                                                        value="{{ isset($options['color-send']) && $options['color-send'] != '' ? $options['color-send'] : '#000000' }}">
                                                </div>

                                                <div class="mb-2">
                                                    <h5 class="mb-2 tt-15">Màu nền nút gửi</h5>
                                                    <input type="text" class="form-control jscolor text-sm"
                                                        name="data[options][background-send]" maxlength="7"
                                                        value="{{ isset($options['background-send']) && $options['background-send'] != '' ? $options['background-send'] : '#000000' }}">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="tab-pane fade show {{ $k == 'vi' ? 'active' : '' }}"
                                                ...
                                                <div class="form-group">
                                                    <label class="form-label" for="content{{ $k }}">Nội dung
                                                        ({{ $k }})
                                                        :</label>
                                                    <textarea class="form-control  text-sm" name="data[content{{ $k }}]" id="content{{ $k }}"
                                                        rows="5" placeholder="Nội dung ({{ $k }})">{{ !empty(Flash::has('content' . $k)) ? Flash::get('content' . $k) : @$item['content' . $k] }}</textarea>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control  text-sm"
                                                        ...
                                                        id="link{{ $k }}"
                                                        placeholder="Link ({{ $k }})"
                                                        value="{{ !empty(Flash::has('link' . $k)) ? Flash::get('link' . $k) : $item['link' . $k] }}">
                                                </div>
