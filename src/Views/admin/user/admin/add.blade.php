                                ...
                                <div class="{{ empty($changepass)?'row':'' }}">
                                        ...
                                        <div class="row" x-data="changePassword()">
                                            ...
                                            <div class="col-12 mb-4">
                                                ...
                                                <ul class="ps-3 mb-0  ul-requirement">
                                                    <li class="mb-1 text-color-dark text-color-dark text-gray-950/60 dark:text-[#b6bee3]" :class="{'text-gray-950/60 dark:text-[#b6bee3]': !isValidLength(changePass.newpassword), 'text-green-500': isValidLength(changePass.newpassword)}">Dài tối thiểu 8 ký tự - càng nhiều càng tốt</li>
                                                    <li class="mb-1 text-color-dark text-color-dark text-gray-950/60 dark:text-[#b6bee3]" :class="{'text-gray-950/60 dark:text-[#b6bee3]': !hasSpecialCharacter(changePass.newpassword), 'text-green-500': hasSpecialCharacter(changePass.newpassword)}">Ít nhất 1 ký tự đặc biệt.</li>
                                                    <li class="mb-1 text-color-dark text-color-dark text-gray-950/60 dark:text-[#b6bee3]" :class="{'text-gray-950/60 dark:text-[#b6bee3]': !hasLowerAndUpperCase(changePass.newpassword), 'text-green-500': hasLowerAndUpperCase(changePass.newpassword)}">Ít nhất 1 chữ thường và 1 chữ in hoa.</li>
                                                    <li class="text-color-dark text-gray-950/60 dark:text-[#b6bee3]" :class="{'text-gray-950/60 dark:text-[#b6bee3]': !doPasswordsMatch, 'text-green-500': doPasswordsMatch}">Nhập lại mật khẩu mới không chính xác.</li>
                                                </ul>
                                            </div>
                                            <div>
                                    ...
                                    @else
                                        ...
                                        <div class="form-group col-4">
                                            ...
                                            <select class="form-control custom-select text-sm" name="data[gender]" id="gender">
