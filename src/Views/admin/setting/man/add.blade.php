                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body card-article">
                        ...
                        <div class="row mt-3">
                            ...
                            @if (!empty($configMan->tiktok))
                                <div class="form-group col-md-4 col-sm-6">
                                    <label for="tiktok">Tên Người Dùng Tiktok:</label>
                                    <input type="text" class="form-control text-sm" name="data[options][tiktok]" id="tiktok" placeholder="Tên người dùng" value="{{ !empty(Flash::has('tiktok')) ? Flash::get('tiktok') : @$options['tiktok'] }}">
                                </div>
                            @endif
                            ...
                            @if (!empty($configMan->coords_iframe))
                                <div class="form-group" id="iframe_map">
                                    ...
                                    <textarea class="form-control text-sm code-javascript" name="data[options][coords_iframe]" id="coords_iframe"
                                        rows="3" placeholder="Iframe google">{{ Func::decodeHtmlChars(Flash::get('coords_iframe')) ?: Func::decodeHtmlChars(@$options['coords_iframe']) }}</textarea>
                                    @if (!empty($options['coords_iframe']))
                                        <div class="preview-map">
                                            {!! Func::decodeHtmlChars($options['coords_iframe']) !!}
                                        </div>
                                    @endif
                                </div>
                            @endif
