        ...
        if (!empty($request->csrf_token)) {
            ...
            if ($id) {
                ...
                if (GalleryModel::where('id', $id)->where('type', $type)->update($data)) {
                    ...
                    return transfer('Cập nhật dữ liệu thành công.', true, url('admin', ['com' => $com, 'act' => 'man', 'type' => $type], ['gallery' => $gallery, 'id_parent' => $id_parent]));
                }
            } else {
                $dataMulti = array();
                $errors = false;
                ...
                if (!empty($errors)) {
                    ...
                    response()->redirect(url('admin', ['com' => $com, 'act' => 'man', 'type' => $type], ['gallery' => $gallery, 'id_parent' => $id_parent]));
                }
            }
        }
    }
